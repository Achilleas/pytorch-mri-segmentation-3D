...
Options:
    ...
    --LISTpath=<str>            Input image number list file [default: ../../Data/MS2017b/train.txt]
    ...
    --snapshotPrefix=<str>      Snapshot model prefix [default: 3Ddeeplab_]
...
def modelInit():
    ...
    model = deeplab_resnet_3D.Res_Deeplab(int(args['--NoLabels']))
